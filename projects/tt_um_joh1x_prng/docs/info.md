...
The seven segment display also shows a random digit based on the current state of the PRNG.
By setting the input pins to a (binary) value between 1 and 9, you can influence the modulus used to generate a random digit.
