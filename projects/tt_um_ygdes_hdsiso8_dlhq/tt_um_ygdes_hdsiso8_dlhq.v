module tt_um_ygdes_hdsiso8_dlhq (clk,
 ...
 wire \lfsr.x2 ;
 wire \lfsr.x3 ;
 wire \siso16_1.siso_in[1] ;
 wire \siso16_1.siso_in[2] ;
 wire \siso16_1.siso_in[3] ;
 wire \siso16_1.slice0.latch ;
 wire \siso16_1.slice0.latch_n ;
 wire \siso16_1.slice0.siso_out[0] ;
 wire \siso16_1.slice0.siso_out[1] ;
 wire \siso16_1.slice0.siso_out[2] ;
 wire \siso16_1.slice0.siso_out[3] ;
 wire \siso16_1.slice1.latch ;
 wire \siso16_1.slice1.latch_n ;
 wire \siso16_1.slice1.siso_out[0] ;
 wire \siso16_1.slice1.siso_out[1] ;
 wire \siso16_1.slice1.siso_out[2] ;
 wire \siso16_1.slice1.siso_out[3] ;
 wire \siso16_1.slice2.latch ;
 wire \siso16_1.slice2.latch_n ;
 wire \siso16_1.slice2.siso_out[0] ;
 wire \siso16_1.slice2.siso_out[1] ;
 wire \siso16_1.slice2.siso_out[2] ;
 wire \siso16_1.slice2.siso_out[3] ;
 wire \siso16_1.slice3.latch ;
 wire \siso16_1.slice3.latch_n ;
 wire \siso16_2.slice0.latch_n ;
 wire \siso16_2.slice0.siso_out[0] ;
 wire \siso16_2.slice0.siso_out[1] ;
 wire \siso16_2.slice0.siso_out[2] ;
 wire \siso16_2.slice0.siso_out[3] ;
 wire \siso16_2.slice1.latch_n ;
 wire \siso16_2.slice1.siso_out[0] ;
 wire \siso16_2.slice1.siso_out[1] ;
 wire \siso16_2.slice1.siso_out[2] ;
 wire \siso16_2.slice1.siso_out[3] ;
 wire \siso16_2.slice2.latch_n ;
 wire \siso16_2.slice2.siso_out[0] ;
 wire \siso16_2.slice2.siso_out[1] ;
 wire \siso16_2.slice2.siso_out[2] ;
 wire \siso16_2.slice2.siso_out[3] ;
 wire \siso16_2.slice3.latch_n ;
 wire net15;
 wire net16;
 wire net17;
 wire net18;
 ...
 sg13g2_inv_1 \BoostLatch.Amp0  (.Y(\siso16_1.slice3.latch ),
    .A(\BoostLatch.A[0] ));
 sg13g2_inv_1 \BoostLatch.Amp1  (.Y(\siso16_1.slice2.latch ),
    .A(\BoostLatch.A[1] ));
 sg13g2_inv_1 \BoostLatch.Amp2  (.Y(\siso16_1.slice1.latch ),
    .A(\BoostLatch.A[2] ));
 sg13g2_inv_1 \BoostLatch.Amp3  (.Y(\siso16_1.slice0.latch ),
    .A(\BoostLatch.A[3] ));
 ...
 sg13g2_inv_2 \J8.boost3  (.Y(\J8.rst3 ),
    .A(\J8.rst ));
 sg13g2_inv_1 \J8.boosta  (.Y(\BoostLatch.A[3] ),
    .A(\J8.DecN[0] ));
 sg13g2_inv_1 \J8.boostb  (.Y(\Decoded8[1] ),
    .A(\J8.DecN[1] ));
 sg13g2_inv_1 \J8.boostc  (.Y(\BoostLatch.A[2] ),
    .A(\J8.DecN[2] ));
 sg13g2_inv_1 \J8.boostd  (.Y(\Decoded8[3] ),
    .A(\J8.DecN[3] ));
 sg13g2_inv_1 \J8.booste  (.Y(\BoostLatch.A[1] ),
    .A(\J8.DecN[4] ));
 sg13g2_inv_1 \J8.boostf  (.Y(\Decoded8[5] ),
    .A(\J8.DecN[5] ));
 sg13g2_inv_1 \J8.boostg  (.Y(\BoostLatch.A[0] ),
    .A(\J8.DecN[6] ));
 ...
 sg13g2_nand3_1 \J8.dec4  (.B(uo_out[2]),
    ...
    .A(uo_out[5]),
    .Y(\J8.DecN[4] ));
 sg13g2_nand3_1 \J8.dec5  (.B(net25),
    .C(\J8.rst3 ),
    .A(net37),
    .Y(\J8.DecN[5] ));
 ...
 sg13g2_nand3_1 \J8.dec7  (.B(uo_out[5]),
    ...
    .A(\J8.J4N[2] ),
    .Y(\J8.DecN[7] ));
 sg13g2_tiehi tt_um_ygdes_hdsiso8_dlhq_10 (.L_HI(net11));
 sg13g2_tiehi tt_um_ygdes_hdsiso8_dlhq_11 (.L_HI(net12));
 sg13g2_tiehi tt_um_ygdes_hdsiso8_dlhq_12 (.L_HI(net13));
 sg13g2_tiehi tt_um_ygdes_hdsiso8_dlhq_13 (.L_HI(net14));
 sg13g2_tiehi tt_um_ygdes_hdsiso8_dlhq_14 (.L_HI(net15));
 sg13g2_tiehi tt_um_ygdes_hdsiso8_dlhq_15 (.L_HI(net16));
 sg13g2_tiehi tt_um_ygdes_hdsiso8_dlhq_16 (.L_HI(net17));
 sg13g2_inv_4 negClkOut_1 (.A(clknet_1_0__leaf_CLK_OUT),
    .Y(net18));
 sg13g2_buf_1 _08_ (.A(D_OUT),
    .X(uo_out[0]));
 sg13g2_buf_1 _09_ (.A(net18),
    .X(uo_out[1]));
 sg13g2_buf_1 _10_ (.A(LFSR_PERIOD),
    .X(uo_out[6]));
 sg13g2_buf_1 _11_ (.A(LFSR_BIT),
    .X(uo_out[7]));
 sg13g2_dfrbpq_2 \lfsr.lfsr0  (.RESET_B(net33),
    .D(net32),
    .Q(LFSR_BIT),
    .CLK(clknet_2_2__leaf_CLK_OUT_regs));
 ...
 sg13g2_and2_1 \lfsr.stall  (.A(net35),
    .B(net8),
    .X(\lfsr.feedback ));
 sg13g2_xor2_1 \lfsr.x_a  (.B(net27),
    .A(\lfsr.feedback ),
    .X(\lfsr.x1 ));
 sg13g2_xor2_1 \lfsr.x_b  (.B(net29),
    .A(\lfsr.feedback ),
    .X(\lfsr.x2 ));
 sg13g2_xor2_1 \lfsr.x_c  (.B(net31),
    .A(\lfsr.feedback ),
    .X(\lfsr.x3 ));
 ...
 sg13g2_inv_2 negShow2 (.Y(SHOW_LFSR_n2),
    .A(net7));
 sg13g2_inv_1 \siso16_1.slice0.Amp  (.Y(\siso16_1.slice0.latch_n ),
    .A(\siso16_1.slice0.latch ));
 sg13g2_dlhq_1 \siso16_1.slice0.l0  (.D(back),
    .GATE(\siso16_1.slice0.latch_n ),
    .Q(\siso16_1.slice0.siso_out[0] ));
 sg13g2_dlhq_1 \siso16_1.slice0.l1  (.D(\siso16_1.siso_in[1] ),
    .GATE(\siso16_1.slice0.latch_n ),
    .Q(\siso16_1.slice0.siso_out[1] ));
 sg13g2_dlhq_1 \siso16_1.slice0.l2  (.D(\siso16_1.siso_in[2] ),
    .GATE(\siso16_1.slice0.latch_n ),
    .Q(\siso16_1.slice0.siso_out[2] ));
 sg13g2_dlhq_1 \siso16_1.slice0.l3  (.D(\siso16_1.siso_in[3] ),
    .GATE(\siso16_1.slice0.latch_n ),
    .Q(\siso16_1.slice0.siso_out[3] ));
 sg13g2_inv_1 \siso16_1.slice1.Amp  (.Y(\siso16_1.slice1.latch_n ),
    .A(\siso16_1.slice1.latch ));
 sg13g2_dlhq_1 \siso16_1.slice1.l0  (.D(\siso16_1.slice0.siso_out[0] ),
    .GATE(\siso16_1.slice1.latch_n ),
    .Q(\siso16_1.slice1.siso_out[0] ));
 sg13g2_dlhq_1 \siso16_1.slice1.l1  (.D(\siso16_1.slice0.siso_out[1] ),
    .GATE(\siso16_1.slice1.latch_n ),
    .Q(\siso16_1.slice1.siso_out[1] ));
 sg13g2_dlhq_1 \siso16_1.slice1.l2  (.D(\siso16_1.slice0.siso_out[2] ),
    .GATE(\siso16_1.slice1.latch_n ),
    .Q(\siso16_1.slice1.siso_out[2] ));
 sg13g2_dlhq_1 \siso16_1.slice1.l3  (.D(\siso16_1.slice0.siso_out[3] ),
    .GATE(\siso16_1.slice1.latch_n ),
    .Q(\siso16_1.slice1.siso_out[3] ));
 sg13g2_inv_1 \siso16_1.slice2.Amp  (.Y(\siso16_1.slice2.latch_n ),
    .A(\siso16_1.slice2.latch ));
 sg13g2_dlhq_1 \siso16_1.slice2.l0  (.D(\siso16_1.slice1.siso_out[0] ),
    .GATE(\siso16_1.slice2.latch_n ),
    .Q(\siso16_1.slice2.siso_out[0] ));
 sg13g2_dlhq_1 \siso16_1.slice2.l1  (.D(\siso16_1.slice1.siso_out[1] ),
    .GATE(\siso16_1.slice2.latch_n ),
    .Q(\siso16_1.slice2.siso_out[1] ));
 sg13g2_dlhq_1 \siso16_1.slice2.l2  (.D(\siso16_1.slice1.siso_out[2] ),
    .GATE(\siso16_1.slice2.latch_n ),
    .Q(\siso16_1.slice2.siso_out[2] ));
 sg13g2_dlhq_1 \siso16_1.slice2.l3  (.D(\siso16_1.slice1.siso_out[3] ),
    .GATE(\siso16_1.slice2.latch_n ),
    .Q(\siso16_1.slice2.siso_out[3] ));
 sg13g2_inv_1 \siso16_1.slice3.Amp  (.Y(\siso16_1.slice3.latch_n ),
    .A(\siso16_1.slice3.latch ));
 sg13g2_dlhq_1 \siso16_1.slice3.l0  (.D(\siso16_1.slice2.siso_out[0] ),
    .GATE(\siso16_1.slice3.latch_n ),
    .Q(\chain4_e[0] ));
 sg13g2_dlhq_1 \siso16_1.slice3.l1  (.D(\siso16_1.slice2.siso_out[1] ),
    .GATE(\siso16_1.slice3.latch_n ),
    .Q(\chain4_e[1] ));
 sg13g2_dlhq_1 \siso16_1.slice3.l2  (.D(\siso16_1.slice2.siso_out[2] ),
    .GATE(\siso16_1.slice3.latch_n ),
    .Q(\chain4_e[2] ));
 sg13g2_dlhq_1 \siso16_1.slice3.l3  (.D(\siso16_1.slice2.siso_out[3] ),
    .GATE(\siso16_1.slice3.latch_n ),
    .Q(\chain4_e[3] ));
 sg13g2_inv_1 \siso16_2.slice0.Amp  (.Y(\siso16_2.slice0.latch_n ),
    .A(\siso16_1.slice0.latch ));
 sg13g2_dlhq_1 \siso16_2.slice0.l0  (.D(\chain4_e[0] ),
    .GATE(\siso16_2.slice0.latch_n ),
    .Q(\siso16_2.slice0.siso_out[0] ));
 sg13g2_dlhq_1 \siso16_2.slice0.l1  (.D(\chain4_e[1] ),
    .GATE(\siso16_2.slice0.latch_n ),
    .Q(\siso16_2.slice0.siso_out[1] ));
 sg13g2_dlhq_1 \siso16_2.slice0.l2  (.D(\chain4_e[2] ),
    .GATE(\siso16_2.slice0.latch_n ),
    .Q(\siso16_2.slice0.siso_out[2] ));
 sg13g2_dlhq_1 \siso16_2.slice0.l3  (.D(\chain4_e[3] ),
    .GATE(\siso16_2.slice0.latch_n ),
    .Q(\siso16_2.slice0.siso_out[3] ));
 sg13g2_inv_1 \siso16_2.slice1.Amp  (.Y(\siso16_2.slice1.latch_n ),
    .A(\siso16_1.slice1.latch ));
 sg13g2_dlhq_1 \siso16_2.slice1.l0  (.D(\siso16_2.slice0.siso_out[0] ),
    .GATE(\siso16_2.slice1.latch_n ),
    .Q(\siso16_2.slice1.siso_out[0] ));
 sg13g2_dlhq_1 \siso16_2.slice1.l1  (.D(\siso16_2.slice0.siso_out[1] ),
    .GATE(\siso16_2.slice1.latch_n ),
    .Q(\siso16_2.slice1.siso_out[1] ));
 sg13g2_dlhq_1 \siso16_2.slice1.l2  (.D(\siso16_2.slice0.siso_out[2] ),
    .GATE(\siso16_2.slice1.latch_n ),
    .Q(\siso16_2.slice1.siso_out[2] ));
 sg13g2_dlhq_1 \siso16_2.slice1.l3  (.D(\siso16_2.slice0.siso_out[3] ),
    .GATE(\siso16_2.slice1.latch_n ),
    .Q(\siso16_2.slice1.siso_out[3] ));
 sg13g2_inv_1 \siso16_2.slice2.Amp  (.Y(\siso16_2.slice2.latch_n ),
    .A(\siso16_1.slice2.latch ));
 sg13g2_dlhq_1 \siso16_2.slice2.l0  (.D(\siso16_2.slice1.siso_out[0] ),
    .GATE(\siso16_2.slice2.latch_n ),
    .Q(\siso16_2.slice2.siso_out[0] ));
 sg13g2_dlhq_1 \siso16_2.slice2.l1  (.D(\siso16_2.slice1.siso_out[1] ),
    .GATE(\siso16_2.slice2.latch_n ),
    .Q(\siso16_2.slice2.siso_out[1] ));
 sg13g2_dlhq_1 \siso16_2.slice2.l2  (.D(\siso16_2.slice1.siso_out[2] ),
    .GATE(\siso16_2.slice2.latch_n ),
    .Q(\siso16_2.slice2.siso_out[2] ));
 sg13g2_dlhq_1 \siso16_2.slice2.l3  (.D(\siso16_2.slice1.siso_out[3] ),
    .GATE(\siso16_2.slice2.latch_n ),
    .Q(\siso16_2.slice2.siso_out[3] ));
 sg13g2_inv_1 \siso16_2.slice3.Amp  (.Y(\siso16_2.slice3.latch_n ),
    .A(\siso16_1.slice3.latch ));
 sg13g2_dlhq_1 \siso16_2.slice3.l0  (.D(\siso16_2.slice2.siso_out[0] ),
    .GATE(\siso16_2.slice3.latch_n ),
    .Q(\siso16_1.siso_in[1] ));
 sg13g2_dlhq_1 \siso16_2.slice3.l1  (.D(\siso16_2.slice2.siso_out[1] ),
    .GATE(\siso16_2.slice3.latch_n ),
    .Q(\siso16_1.siso_in[2] ));
 sg13g2_dlhq_1 \siso16_2.slice3.l2  (.D(\siso16_2.slice2.siso_out[2] ),
    .GATE(\siso16_2.slice3.latch_n ),
    .Q(\siso16_1.siso_in[3] ));
 sg13g2_dlhq_1 \siso16_2.slice3.l3  (.D(\siso16_2.slice2.siso_out[3] ),
    .GATE(\siso16_2.slice3.latch_n ),
    .Q(D_OUT));
 ...
 sg13g2_buf_1 input8 (.A(ui_in[7]),
    .X(net9));
 sg13g2_tiehi tt_um_ygdes_hdsiso8_dlhq_9 (.L_HI(net10));
 ...
 sg13g2_dlygate4sd3_1 hold1 (.A(\LFSR_state8[7] ),
    .X(net19));
 sg13g2_dlygate4sd3_1 hold2 (.A(\LFSR_state8[4] ),
    .X(net20));
 ...
 sg13g2_dlygate4sd3_1 hold8 (.A(uo_out[2]),
    .X(net26));
 sg13g2_dlygate4sd3_1 hold9 (.A(\LFSR_state8[5] ),
    .X(net27));
 sg13g2_dlygate4sd3_1 hold10 (.A(\lfsr.x1 ),
    .X(net28));
 sg13g2_dlygate4sd3_1 hold11 (.A(\LFSR_state8[3] ),
    .X(net29));
 sg13g2_dlygate4sd3_1 hold12 (.A(\lfsr.x2 ),
    .X(net30));
 ...
 sg13g2_dlygate4sd3_1 hold15 (.A(INT_RESET),
    .X(net33));
 sg13g2_dlygate4sd3_1 hold16 (.A(SISO_in),
    .X(net34));
 sg13g2_dlygate4sd3_1 hold17 (.A(LFSR_BIT),
    .X(net35));
 sg13g2_dlygate4sd3_1 hold18 (.A(back),
    .X(net36));
